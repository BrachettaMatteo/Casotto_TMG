...
public class GestioneMateriali implements Initializable {
    ...
    private final ObservableList<Materiale> listaMateriali = FXCollections.observableArrayList();
    ...
    @FXML
    void aggiungiMateriale() throws SQLException {
    ...
    @FXML
    void rimuoviMateriale() throws SQLException {
    ...
    public void aggiornaQauntitaMateriale() throws SQLException {
        Materiale materiale = tableMateriali.getSelectionModel().getSelectedItem();
