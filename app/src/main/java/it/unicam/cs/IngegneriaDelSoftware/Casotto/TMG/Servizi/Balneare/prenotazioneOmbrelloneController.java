...
import it.unicam.cs.IngegneriaDelSoftware.Casotto.TMG.Attori.Dipendete.ControllerGestione.IntervalloDate;
...
public class prenotazioneOmbrelloneController implements Initializable {
    ...
    private final ObservableList<Integer> nombreloni = FXCollections.observableArrayList();
